...
namespace MathForGames
{
    class Sprite
    {
        ...
        /// <param name="path">The file path of the image to use as the textures</param>
        ...
        /// <summary>
        /// Draws the sprite using the ratation, translation and scale of the given transform
        /// </summary>
        /// <param name="transform">The transform of the actor that owns the sprite</param>
        public void Draw(Matrix3 transform)
        {
            //Finds the scale of the spirte
